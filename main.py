...
class Utility(commands.Cog):
    ...
    async def setprefix(self, ctx: Context, *, newprefix: str):
        bot.command_prefix = newprefix
        await ctx.send(f"Prefix changed to '{newprefix}'")

    @commands.command(name="subscribe")
    async def subscribe(self, ctx: Context, email: str) -> None:
    ...
    async def image(self, ctx: Context, *prompt: str) -> None:
        """Dall-E image"""
        print(prompt)
    ...
    async def chat(self, ctx: Context, *prompt: str) -> None:
        """ChatGPT chat"""
    ...
    @commands.command(name="deepai")
    async def deepai(self, ctx: Context, *prompt: str) -> None:
    ...
    async def qr(self, ctx: Context, *url: str) -> None:
    ...
    async def timezone(self, ctx: Context, continent: str, city: str):
...
class Fun(commands.Cog):
    ...
    @commands.command(name="list_memes")
    async def list_memes(self, ctx: Context) -> None:
    ...
    @commands.command(name="play_hangman")
    async def play_hangman(self, ctx: Context) -> None:
    ...
    async def rps(self, ctx: Context, player_choice: str) -> None:
        """Rock, paper, scissors!"""
